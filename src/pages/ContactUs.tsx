      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Have questions or ready to get started? We're here to help you with all your digital marketing needs.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">info@digisanchaar.com</p>
                        <p className="text-gray-700">support@digisanchaar.com</p>
                      </div>
                    </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl font-bold mb-3">Ready to Elevate Your Digital Presence?</h2>
            <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
              Whether you have questions or are ready to get started, we're here to help you achieve your digital marketing goals.
            </p>
